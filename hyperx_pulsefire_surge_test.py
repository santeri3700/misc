...
# DPIs
# DPI calculation -> DPI / 50 = DPI Value (15000 / 50 = 300 = 0x2c:0x01)
#dpi_1 = [0x14, 0x00] # 1000 dpi
#dpi_2 = [0xa0, 0x00] # 8000 dpi
#dpi_3 = [0x40, 0x01] # 16000 dpi
dpi_1 = [0xfa, 0x00] # 12500 dpi
dpi_2 = [0x18, 0x01] # 14000 dpi
dpi_3 = [0x2c, 0x01] # 15000 dpi
...
data_packet3 = [
0x07, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00] +  dpi_1 + dpi_2 + dpi_3 + [0x80, 0x00,
0x40, 0x01, 0x08, 0x00] + dpi_1 + dpi_2 + dpi_3 + [0x80, 0x00, 0x40, 0x01, 0x08, 0x00,
